...
@MapperScan(basePackages = { "com.aboo.vbbs.data.mapper.bbs" }, sqlSessionTemplateRef = "sqlSessionTemplate")
public class Db1Config {
	...
	/* ########数据源配置-start######## */
	@ConfigurationProperties(prefix = "spring.datasource.bbs")
	@Bean
	...
	public PlatformTransactionManager transManager(@Qualifier("dataSource") DataSource dataSource) {
