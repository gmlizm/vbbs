package com.aboo.vbbs.web.util.identicon.generator;
...
public class DefaultGenerator implements IBaseGenartor {
	...
	public Color getForegroundColor() {
		// int r = Integer.parseInt(String.valueOf(hash.charAt(hash.length() - 1)), 16)
		// * 16;
		// int g = Integer.parseInt(String.valueOf(hash.charAt(hash.length() - 2)), 16)
		// * 16;
		// int b = Integer.parseInt(String.valueOf(hash.charAt(hash.length() - 3)), 16)
		// * 16;
		//
		// return new Color(r, g, b);
